...
document.getElementById('formulario').addEventListener('submit', function (event) { 
    ...
    formData.append('participantesMin', document.getElementById('participantesMin').value); 
    formData.append('participantesMax', document.getElementById('participantesMax').value);
    ...
    fetch(URL + 'juegos', { 
        ...
        .then(function (data) { alert('Juego agregado correctamente.');
